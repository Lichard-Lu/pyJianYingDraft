...
class CapCut_Voice_filters_effect_type(EffectEnum):
...
class CapCut_Voice_characters_effect_type(EffectEnum):
...
class CapCut_Speech_to_song_effect_type(EffectEnum):
